            ...
            <div className="row">
              <div className="col-sm-6 d-md-none d-block ">
                <div className="d-flex justify-content-center mb-4">
                  <img className="main-img" src={require("../../assets/tayyab_naqvi.png")} />
                </div>
              </div>
              <div className="col-sm-6 align-self-center">
                <h1 className="fw-bold">Front-End Engineer</h1>
                <p className="my-3" style={{ textAlign: "justify" }}>
                  Hi, I'm <strong style={{ color: "var(--orange)" }}>Tayyab Naqvi</strong>. I am web & app developer. I believe web develop can be more miscellaneous and inclining. With a mission to present various possibilities of web and app development, I am pursuing new aspects through
