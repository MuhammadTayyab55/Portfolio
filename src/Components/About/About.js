        ...
        <div className="row">
          <div className="col-lg-8 col-12">
            ...
            <p className="my-2 paragraph">
              Hey! My name is Tayyab Naqvi. I am Web and App developer. I am very amorous and passionate with my work. I have attained the learning and abilities that is required to make your plan, a sucess. I am proficient in developing creating user interfaces, writing and testing codes,
          ...
          <div className="col-sm-4 d-none d-lg-block">
            <div className="about-detail">
              <div className="">
                ...
                <p>Muhammad Tayyab Naqvi</p>
                <h6 className="fw-bold mb-0">Email :</h6>
                <p>
                  <a href="mailto:sharjeelkhalid416@gmail.com">tayyabnaqvi55@gmail.com</a>
                </p>
